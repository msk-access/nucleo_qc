class: Workflow
cwlVersion: v1.0
id: nucleo_qc_generator
label: nucleo_qc_generator
$namespaces:
  s: 'https://schema.org/'
...
steps:
  ...
  - id: duplex_bam_mosdepth
    in:
      - id: files
        linkMerge: merge_flattened
        source:
          - duplex_bam_mosdepth/per_base_bed
          - duplex_bam_mosdepth/per_region_bed
          - duplex_bam_mosdepth/global_distribution
          - duplex_bam_mosdepth/region_distribution
      - id: output_directory_name
        default: duplex_bam_mosdepth
        source: sample_name
    out:
      - id: directory
    run: ../cwl-commandlinetools/expression_tools/put_in_dir.cwl
    label: duplex_bam_mosdepth
