...
steps:
  ...
  - id: gatk_mean_quality_by_cycle_4_1_8_0
    ...
    out:
      ...
      - id: gatk_mean_quality_by_cycle_chart_output
    run: >-
      ../cwl-commandlinetools/gatk_mean_quality_by_cycle/4.1.8.0/gatk_mean_quality_by_cycle_4.1.8.0.cwl
  ...
  - id: gatk_revert_sam_4_1_8_0
    ...
    run: ../cwl-commandlinetools/gatk_revert_sam/4.1.8.0/gatk_revert_sam_4.1.8.0.cwl
